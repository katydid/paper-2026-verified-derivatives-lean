...
* Symbolic regular expressions [Regex](./Regex.lean) with the usual derive, validate and filter functions and proofs of their correctness.
...
* In the [Memoize](./Memoize/) subfolder we define the optimized Katydid algorithm with memoization.
* In the [IfExpr](./IfExpr/) subfolder we define an alternative implementation without any heap allocations, but with exponential memoization space blowup.
